        ...
        <div class="card card-body mx-3 mx-md-4 mt-n6">
            <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                    ...
                    @endif
                    <form wire:submit.prevent='updateArea'>
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <br>
                                <input wire:model="estado"  type="radio" id=true value= true >
                                <label for=ture >activo</label>

                                <input wire:model="estado"  type="radio" id=false value= false>
                                <label for=false 
                                >Inactivo</label>
                                @error('estado')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <br>
                                        <input type="radio"  wire:model="tipo" id="deporte" name="tipo" value="Deporte" />
                                        <label for="deporte">Deporte</label>
                                  
                                        <input type="radio" wire:model="tipo"  id="comun" name="tipo" value="Comun" />
