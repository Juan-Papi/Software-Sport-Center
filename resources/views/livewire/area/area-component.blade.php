            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Areas</h6>
                    </div>
                    {{-- boton añadir --}}
                            ...
                            <tbody>
                                @foreach ($areas as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-xm font-weight-bold mb-0">{{ $user->descripcion }}</p>
                                        ...
                                        <td>
                                            <p class="text-sm font-weight-bold mb-0">{{ $user->estado ? 'Activo' : 'Inactivo'}}</p>
                                        </td>
                                        <td class="align-middle">
                                          <a href="{{ route('area.editar', ['area_id' => $user->id]) }}"
                                                  ...
                                                  <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="modal-footer">
                                                        <button type="button" class="btn btn-primary btn-sm"wire:click="deleteArea({{ $user->id }})">Eliminar</button>
