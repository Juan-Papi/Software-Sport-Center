            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    ...
                    <div class=" me-3 my-3 text-end">
                        <a class="btn bg-gradient-dark mb-0" href="{{ route('rol.registrar') }}"><i
                                ...
                                @foreach ($roles as $rol)
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $rol->id }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('rol.editar', ['rol_id' => $rol->id]) }}"
                                        ...
                                        <td class="align-middle">
                                            <a href="#" class="text-secondary font-weight-bold text-xs"
                                                ...
                                                data-bs-target="#modal-notification-{{ $rol->id }}">
                                                Eliminar
                                                <div class="modal fade" id="modal-notification-{{ $rol->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-danger modal-dialog-centered modal-"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button"
                                                                    class="btn btn-primary btn-sm"wire:click="deleteRol({{ $rol->id }})">Eliminar</button>
                                                                <button type="button"
